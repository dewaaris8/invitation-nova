...
export default function Home() {
  ...
  useEffect(() => {
    ...
    gsap.to(bgRef.current, {
      ...
      duration: 1,
      onComplete: () => {
        gsap.to(bgRef.current as HTMLDivElement, { opacity: 1, duration: 1 });
      },
    });
  }, [currentImage]);
        ...
        <div className="w-full flex z-10 relative h-max">
          <div className="w-full bg-[#111111] md:max-w-[450px] lg:max-w-[450px] h-max lg:max-h-screen mx-auto">
            ...
            <div
              ...
              style={{ backgroundImage: `url(${images[currentImage]})` }} // <-- diperbaiki
            >
            ...
            <div className="w-full py-[100px] flex px-[10px] flex-col gap-5 items-center justify-center bg-[#111111] text-white h-max">
              <div className="w-[85%] h-[180px] max-h-[180px] flex justify-center relative">
                ...
                <div
                  style={{ backgroundImage: "url('/images/nova4.jpg')" }}
                  className="w-full bg-cover bg-center bg-no-repeat flex justify-start relative"
                />
            ...
            {/* WEDDING EVENT */}
            <div className="text-center relative bg-[#111111] z-50 mt-7 gap-2 py-[150px] flex text-white flex-col items-center justify-center px-[10px]">
              <div className="absolute w-full inset-0 bg-[#111111] opacity-50" />
              <div
